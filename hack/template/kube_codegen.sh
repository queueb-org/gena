...
#: NOTE, this script is originally modified kubernetes/code-generator
#: It changes validations-gen sequence with additional cli params
#: Once it can be possible to use original kube_codegen.sh => please do

READONLY_PKG="${READONLY_PKG:-"time,\
